# debt-014 — RtuClient 경로에서 kFrameShort 구조적 도달 불가 (진단성 격차)

| 필드 | 값 |
| --- | --- |
| id | debt-014 |
| 유형 | 기술 |
| 위치 | src/Common/comm/modbus_rtu/src/rtu_client.cpp:46-63 (수신 루프) + src/Common/comm/modbus_rtu/src/rtu_frame.cpp preflight |
